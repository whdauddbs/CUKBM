...
<body>
   <jsp:include page="cb_MainBar.jsp"></jsp:include>
      <div class="container">
         <div class="outer">
                   <a href="/CUKBM/board?event=${event}&page=1&select=1"><b><input type=button value="팀" class="randombutton"></b></a>
                   <a href="/CUKBM/board?event=${event}&page=1&select=0"><b><input type=button value="개인" class="randombutton"></b></a>

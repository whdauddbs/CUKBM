      ...
      <div class="container">
         <div class="outer">
                   ...
                   <c:if test="${empty sessionScope.id}">
                      <a href="./login_page?path=<%=path%>"><b><input TYPE="button" value="랜덤" class="randombutton" src="./resources/random.PNG"></b></a>
                      <a href="./login_page?path=<%=path%>"><b><input TYPE="button" value="방 생성" class="randombutton" src="./resources/newroom.PNG"></b></a>
                   </c:if>
                   <c:if test="${not empty sessionScope.id}">
                      <a href="./match?value=random&event=${event}"><b><input TYPE="IMAGE" value="랜덤" class="randombutton" src="./resources/random.PNG"></b></a>
